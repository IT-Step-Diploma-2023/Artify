...
namespace Artify.Migrations
{
    ...
    [Migration("20230805132855_new_init_01")]
    partial class new_init_01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artify.Models.DbModels.WorkPreferences.Vacancy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Artify.Models.DbModels.WorkPreferences.Vacancy", b =>
                {
                    ...
                    b.HasOne("Artify.Models.DbModels.Users.User", "Employer")
                        .WithMany("Vacancies")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Artify.Models.DbModels.WorkPreferences.WorkPreference", b =>
                {
                    b.HasOne("Artify.Models.DbModels.WorkPreferences.FreelanceAvailability", null)
                        .WithMany("WorkPreferences")
                        .HasForeignKey("FreelanceAvailabilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Artify.Models.DbModels.WorkPreferences.FullTimeAvailability", null)
                        .WithMany("WorkPreferences")
