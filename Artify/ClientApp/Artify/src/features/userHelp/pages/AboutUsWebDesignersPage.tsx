...
import AboutUsMenu from '../components/layout/AboutUsMenu';
  ...
  const AboutUsWebDesignersPage: FunctionComponent = () => {   
    ...
    const text10=t('aboutUsPage.text16');
...
<Grid container spacing={2} display={'flex'}>
  ...
  <Grid item xs={1} style={{display:'inline-block'}}></Grid>
    ...
    <Grid item xs={5} style={{display:'inline-block'}}>
      <Stack>
        <img src="../images/webDesigners1.png"></img>
        <img src="../images/webDesigners4.png" style={{marginTop:'28.5px'}}></img>
      </Stack>
    </Grid>
    <Grid item xs={5} style={{display:'inline-block'}}>
      <Stack>
        <img src="../images/webDesigners2.png"></img>
        <img src="../images/webDesigners3.png" style={{marginTop:'28.5px'}}></img>
        <img src="../images/webDesigners5.png" style={{marginTop:'28.5px'}}></img>
      </Stack>
    </Grid>
  </Grid>  
...
export default AboutUsWebDesignersPage;
