...
const AboutUsUiUxPage: FunctionComponent = () => {
  ...
  return <>
    ...
    <Grid container spacing={2} display={'flex'} sx={{ marginTop: '100px' }}>
      ...
      <Grid item xs={5} style={{ display: 'inline-block' }}>
        <Stack>
          <img src="../images/uiux1.png"></img>
          <img src="../images/uiux4.png" style={{ marginTop: '28.5px' }}></img>
        </Stack>
      </Grid>
      <Grid item xs={5} style={{ display: 'inline-block' }}>
        <Stack>
          <img src="../images/uiux2.png"></img>
          <img src="../images/uiux3.png" style={{ marginTop: '28.5px' }}></img>
          <img src="../images/uiux5.png" style={{ marginTop: '28.5px' }}></img>
        </Stack>
      </Grid>
    </Grid>
...
export default AboutUsUiUxPage;
