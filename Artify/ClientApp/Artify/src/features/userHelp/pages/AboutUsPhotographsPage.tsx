...
import AboutUsMenu from
 '../components/layout/AboutUsMenu';



const AboutUsPhotographsPage: FunctionComponent = () => {
  ...
  const text10 = t('aboutUsPage.text11');
  ...
  return <>
    ...
    <img src="../images/team.jpg"
      style={{
        background: 'url(pexels-huy-chien-tran-1756665.jpg)',
    ...
    <Grid container spacing={2} display={'flex'} sx={{ marginTop: '100px' }}>
      <Grid item xs={1} style={{ display: 'inline-block' }}></Grid>

      <Grid item xs={5} style={{ display: 'inline-block' }}>
        <Stack>
          <img src="../images/photographs1.png"></img>
          <img src="../images/photographs4.png" style={{ marginTop: '28.5px' }}></img>
        </Stack>
      </Grid>
      <Grid item xs={5} style={{ display: 'inline-block' }}>
        <Stack>
          <img src="../images/photographs2.png"></img>
          <img src="../images/photographs3.png" style={{ marginTop: '28.5px' }}></img>
          <img src="../images/photographs5.png" style={{ marginTop: '28.5px' }}></img>
        </Stack>
      </Grid>
    </Grid>
...
export default AboutUsPhotographsPage;
