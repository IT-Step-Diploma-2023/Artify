...
import AboutUsMenu from '../components/layout/AboutUsMenu';
  ...
  const AboutUsProductDesignersPage: FunctionComponent = () => {   
    ...
    const text10=t('aboutUsPage.text13');
    const text11=t('aboutUsPage.text14');
...
<Grid container spacing={2} display={'flex'}>
  ...
  <Grid item xs={1} style={{display:'inline-block'}}></Grid>
    ...
    <Grid item xs={5} style={{display:'inline-block'}}>
      <Stack>
        <img src="../images/productDesigners1.png"></img>
        <img src="../images/productDesigners4.png" style={{marginTop:'28.5px'}}></img>
      </Stack>
    </Grid>
    <Grid item xs={5} style={{display:'inline-block'}}>
      <Stack>
        <img src="../images/productDesigners2.png"></img>
        <img src="../images/productDesigners3.png" style={{marginTop:'28.5px'}}></img>
        <img src="../images/productDesigners5.png" style={{marginTop:'28.5px'}}></img>
      </Stack>
    </Grid>
  </Grid>  
...
export default AboutUsProductDesignersPage;
