...
import AboutUsMenu from '../components/layout/AboutUsMenu';
  ...
  const AboutUsBrandsPage: FunctionComponent = () => {   
    ...
    const text10=t('aboutUsPage.text12');
  ...
  <Grid item xs={1} style={{display:'inline-block'}}></Grid>
    ...
    <Grid item xs={5} style={{display:'inline-block'}}>
      <Stack>
        ...
        <img src="../images/brands4.png" style={{marginTop:'28.5px'}}></img>
      </Stack>
    </Grid>
    <Grid item xs={5} style={{display:'inline-block'}}>
      <Stack>
        <img src="../images/brands2.png"></img>
        <img src="../images/brands3.png" style={{marginTop:'28.5px'}}></img>
        <img src="../images/brands5.png" style={{marginTop:'28.5px'}}></img>
      </Stack>
    </Grid>
  </Grid>  
...
export default AboutUsBrandsPage;
